...
HD_PWD='/home/dlanyar/Documents/POLYTECH/SoPC/SOPC/SOPC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCORE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCORE.tcl
